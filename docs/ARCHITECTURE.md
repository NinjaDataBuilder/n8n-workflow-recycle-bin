...
The tested adapters currently cover n8n `2.32.5`, `2.35.3`, `2.36.7`, `2.36.8`, and `2.39.7`. Any other exact version is refused by the installer until tested and explicitly added to `src/compatibility.mjs`.
